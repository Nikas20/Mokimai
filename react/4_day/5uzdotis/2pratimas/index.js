...
function logItemNames() {
  ...
  items.forEach((fruct) => console.log(fruct.name))
}
...
function calculateTotalInventory() {
  ...
  return items.reduce((accumulator, invent) => accumulator +=invent.inventory, 0)
}
...
function calculateAllInventoryPrice() {
  ...
  return items.reduce((accumulator, invent) => accumulator +=invent.inventory * invent.price, 0)
}
...
function getItemPriceByName(name) {
  ...
  return items.find((fruct) => fruct.name === name).price
}
...
function calculateTotalCartPrice() {
  ...
  return cart.reduce((accumulator, product) => accumulator += items[product].price, 0)
}
