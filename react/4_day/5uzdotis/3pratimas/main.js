...
function renderUserCards(users) {
  ...
  const userInfo = users.map((user) => createUserCard(user));
  userInfo.forEach((info) =>
    USER_CONTAINER.insertAdjacentHTML("afterend", info)
  );
}
